...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    while True:
        ...
        if isinstance(policy, LoadedGaussianPolicy):
            ...
            ac = policy(ptu.from_numpy(ob)).sample().detach().cpu().numpy() # HINT: this is a numpy array
        ...
        steps += 1
        rollout_done = steps >= max_path_length or truncated or terminated # HINT: this is either 0 or 1
